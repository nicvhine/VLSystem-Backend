 ...
 * @extends Client
 */
class FileClient extends client_js_1.Client {
    authType = index_js_1.AuthenticationType.JWT;
    saveFilePath = '';
    /**
    ...
    async downloadFile(file, path) {
        ...
        log(`Saving to ${path}`);
        await (0, promises_1.pipeline)(response.body, (0, node_fs_1.createWriteStream)(path));
        log('File saved');
    }
}
