...
class Client {
     ...
     */
    static transformers = {
        'camelCaseObjectKeys': transformers_js_1.camelCaseObjectKeys,
        'snakeCaseObjectKeys': transformers_js_1.snakeCaseObjectKeys,
        'kebabCaseObjectKeys': transformers_js_1.kebabCaseObjectKeys,
        'omit': transformers_js_1.omit,
    };
    /**
     * The type of authentication used for the client's requests.
     */
    authType = index_js_1.AuthenticationType.QUERY_KEY_SECRET;
    /**
    ...
    async addAuthenticationToRequest(request) {
        ...
        if (!Object.values(index_js_1.AuthenticationType).includes(this.authType)) {
            throw new Error('No authentication type set');
        }
        if ([index_js_1.AuthenticationType.OAUTH2, index_js_1.AuthenticationType.CIBA].includes(this.authType)) {
            throw new Error('OAuth2 and CIBA authentication is not supported for this Client');
        }
        switch (this.authType) {
            case index_js_1.AuthenticationType.BASIC:
                return this.addBasicAuthToRequest(request);
            case index_js_1.AuthenticationType.JWT:
                return this.addJWTToRequest(request);
            case index_js_1.AuthenticationType.QUERY_KEY_SECRET:
