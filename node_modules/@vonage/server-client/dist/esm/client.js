...
import { camelCaseObjectKeys, kebabCaseObjectKeys, snakeCaseObjectKeys, omit, } from './transformers.js';
...
export class Client {
    ...
    async addAuthenticationToRequest(request) {
        ...
        if ([AuthenticationType.OAUTH2, AuthenticationType.CIBA].includes(this.authType)) {
    ...
    async parseResponse(request, response) {
        ...
        try {
            ...
            if (contentLength > 0) {
                throw new VetchError('Failed to decode response body', request, response);
            }
        }
