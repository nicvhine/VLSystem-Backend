...
import { MissingApiKeyError, MissingApiSecretError, InvalidApiKeyError, InvalidApiSecretError, MissingSignatureError, InvalidSignatureAlgorithmError, } from './errors/index.js';
...
export class Auth {
    ...
    constructor(opts) {
        ...
        if (existsSync(opts?.privateKey)) {
            ...
            privateKey = readFileSync(opts?.privateKey).toString();
        }
