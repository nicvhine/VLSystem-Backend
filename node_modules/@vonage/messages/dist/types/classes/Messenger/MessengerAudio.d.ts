...
import { MessengerAudioParams, MessengerType } from '../../types/index.js';
...
export declare class MessengerAudio extends AbstractAudioMessage implements MessengerAudioParams {
     ...
     * ```
     */
    constructor(params: Omit<MessengerAudioParams, 'channel' | 'messageType'>);
}
//# sourceMappingURL=MessengerAudio.d.ts.map