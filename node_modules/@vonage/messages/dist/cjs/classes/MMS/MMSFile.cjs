...
exports.MMSFile = void 0;
const AbstractFileMessage_js_1 = require("../AbstractFileMessage.js");
 ...
 * @group MMS
 */
class MMSFile extends AbstractFileMessage_js_1.AbstractFileMessage {
    /**
     * The channel for this message (always 'mms').
     */
    channel = index_js_1.Channels.MMS;
    /**
...
exports.MMSFile = MMSFile;
//# sourceMappingURL=MMSFile.js.map