...
const apiCallsToCalls = (call) => {
    delete call._links;
    const transformedCall = Client.transformers.camelCaseObjectKeys(call, true, true);
...
export class Voice extends Client {
    ...
    async getCallsPage(params) {
        const resp = await this.sendGetRequest(`${this.config.apiHost}/v1/calls`, Client.transformers.snakeCaseObjectKeys(params));
        return {
            ...resp.data,
        };
    }
    ...
    async createOutboundCall(call) {
        ...
        const result = Client.transformers.camelCaseObjectKeys(resp.data, true, true);
