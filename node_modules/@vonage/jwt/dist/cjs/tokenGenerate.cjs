...
const tokenGenerate = (applicationId, privateKey, opts) => {
    ...
    if (!applicationId) {
        throw new index_js_1.MissingApplicationIdError();
    }
    if (!privateKey) {
        throw new index_js_1.MissingPrivateKeyError();
    }
    if (typeof applicationId !== 'string') {
        throw new index_js_1.InvalidApplicationIdError();
    }
    if (typeof privateKey !== 'string' && !(privateKey instanceof Buffer)) {
        throw new index_js_1.InvalidPrivateKeyError();
    }
