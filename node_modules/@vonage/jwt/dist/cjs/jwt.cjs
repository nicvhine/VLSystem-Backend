...
exports.JWT = void 0;
const tokenGenerate_js_1 = require("./tokenGenerate.js");
...
class JWT {
    ...
    tokenGenerate(applicationId, privateKey, opts) {
        return (0, tokenGenerate_js_1.tokenGenerate)(applicationId, privateKey, opts);
    }
    /**
    ...
    verifySignature(jwt, privateKey) {
        return (0, verifySignature_js_1.verifySignature)(jwt, privateKey);
    }
    /**
    ...
    validateOptions(opts) {
        return (0, tokenGenerate_js_1.validateOptions)(opts);
    }
}
exports.JWT = JWT;
