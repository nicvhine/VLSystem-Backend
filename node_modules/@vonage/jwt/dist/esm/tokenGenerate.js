...
import { MissingApplicationIdError, MissingPrivateKeyError, InvalidPrivateKeyError, InvalidApplicationIdError, } from './errors/index.js';
 ...
 * ```
 */
export const tokenGenerate = (applicationId, privateKey, opts) => {
